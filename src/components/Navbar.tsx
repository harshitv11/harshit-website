...
const Navbar = () => {
  ...
  useEffect(() => {
    // ScrollSmoother is desktop-only — on mobile it adds main-thread
    // overhead and can leave the page frozen if never unpaused. Mobile
    // uses normal native scrolling.
